    ...
    <div className={styles.page}>
      ...
      <header className={styles.hero}>
        <h1 className={styles.heroTitle}>
          Shade
          <br />
          <span className={styles.heroAccent}>Sealed-Bid Auctions</span>
        </h1>
        <p className={styles.heroSub}>
          Private sealed-bid auctions on Starknet. Bids stay hidden until
          reveal. First-price and Vickrey formats. Powered by STRK20.
        </p>
      </header>

      <main style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 32 }}>
        <AuctionPanel />
        <WalletAccountV6Tag />
      </main>
      ...
      <footer className={styles.footer}>
        ...
        <span>Shade — Sealed-Bid Auctions on Starknet</span>
        <span className={styles.footerDot}>·</span>
